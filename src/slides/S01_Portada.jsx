    ...
    <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.4rem', zIndex: 1 }}>
          <motion.div {...fade(0.3)}>
            <div style={{
              ...
              background: 'rgba(69,197,190,0.15)', border: '1px solid rgba(69,197,190,0.4)',
              borderRadius: '100px', padding: '0.35rem 1.2rem',
              fontSize: '0.72rem', fontWeight: 600, color: '#45C5BE',
              letterSpacing: '0.1em', textTransform: 'uppercase',
            }}>
              Módulo 3 · Taller de Capacitación
            </div>
          </motion.div>
          ...
          <motion.p {...fade(0.7)} style={{
            ...
            letterSpacing: '0.02em', margin: 0, lineHeight: 1.6,
          }}>
            De la atención al acompañamiento:<br />
            Cómo cada interacción construye confianza,<br />
      ...
      >
        ...
        <div style={{
          ...
          background: 'linear-gradient(0deg, rgba(12,45,78,0.75) 0%, transparent 100%)',
        }} />
